...
import { fetchUniqueStatesFromDB } from "@/services/database";
      ...
      <Tabs defaultValue="avaliacao" className="mb-8">
        ...
        <TabsContent value="ranking">
          <Card>
            ...
            <CardContent>
              <p className="mb-4">
                Veja o ranking completo das cidades avaliadas pelo IDECICLO, com detalhes sobre a classificação
                e pontuação de cada uma.
              </p>
              <Link to="/ranking">
