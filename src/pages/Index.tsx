    ...
    try {
      ...
      if (success) {
        toast({
          ...
          description: "Os dados foram migrados com sucesso para o banco de dados.",
        });
      } else {
        toast({
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Selecione uma cidade e avalie os segmentos cicloviários.</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Informações sobre o projeto e como contribuir.</CardDescription>
          </CardHeader>
          <CardContent>
            <p>Saiba mais sobre o projeto e como você pode contribuir.</p>
            <Button variant="secondary" asChild>
              <a href="https://github.com/DanielFranca/ideciclo-frontend" target="_blank" rel="noopener noreferrer">
                Ver no GitHub
              </a>
            </Button>
          </CardContent>
